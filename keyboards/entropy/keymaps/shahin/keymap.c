...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _______, _______, _______, _______, _______,        KC_LEFT, KC_DOWN,  KC_UP, KC_RIGHT, _______, _______,  KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______,       _______,     _______,  \
    ...
    _______, _______, _______, _______, _______, KC_F1,    KC_F2,   KC_F3,   KC_F4,  KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,   KC_F11,  KC_F12,      _______,      _______,  \
             _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_PGUP, _______, _______, _______,    _______,   _______,  \
    _______, _______, _______, _______, _______,        KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______,        _______,      _______,  \
    ...
    CK_DOWN, _______, _______, _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,     _______,  TG(_NORMAL),  \
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    if (status_en) {
        ...
        // First LED
        rgblight_setrgb_at(normal, qwerty, 0, LED0);
        ...
        case _RAISE:
            ...
            break;
        case _FN:
            rgblight_setrgb_at(128, 0, 0, LED1);
            break;
        default:
...
bool led_update_kb(led_t led_state) {
    ...
    */
    ...
    if (status_en){
        ...
        uint8_t caps = led_state.caps_lock ? 128 : 0;
        uint8_t num = led_state.num_lock ? 64 : 0; // Inverted as Numlock should be on by default
