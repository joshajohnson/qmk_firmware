...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_BSPC,      KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,                   KC_ENT,   KC_4,    KC_5,    KC_6,    KC_PPLS,
	KC_LSHIFT,        KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH,       KC_RSHIFT,  KC_UP,    KC_1,    KC_2,    KC_3,
	KC_LCTL, KC_LGUI, KC_LALT,                  KC_SPACE,               KC_RALT, KC_RCTL, MO(1), KC_LEFT, KC_DOWN,  KC_RGHT, KC_0,  KC_DOT,      KC_PENT
    ),
